  ...
  return isTerms ? (
    <div className="legal-copy">
      ...
      <section>
        ...
        <p>
          Os usuários são responsáveis por conferir dados extraídos de NFC-e,
          categorias, nomes de produtos, valores e demais registros antes de
          utilizá-los em decisões pessoais.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          O usuário pode exportar seus dados e solicitar exclusão pelas opções
          disponíveis. O acesso também poderá ser suspenso em caso de abuso,
          risco de segurança ou encerramento do beta.
        </p>
      </section>
    </div>
  ) : (
    <div className="legal-copy">
      ...
      <section>
        ...
        <p>
          ...
          solicitar exclusão. O administrador pode gerenciar a família e seus
          membros conforme as regras do aplicativo.
        </p>
      </section>
      <section>
...
export function LegalDocumentModal({ type, onClose }: ModalProps) {
  const isTerms = type === "terms";
  ...
  return (
    ...
    >
      ...
      >
        <header className="legal-modal-heading">
          <div>
            <p className="eyebrow">Gestão de Compras</p>
            <h2 id="legal-modal-title">
              {isTerms ? "Termos do beta" : "Aviso de Privacidade"}
            </h2>
            <p>
              Versão {isTerms ? TERMS_VERSION : PRIVACY_VERSION} · Atualizado em
              18/07/2026
        ...
        <footer className="legal-modal-footer">
          <button className="capture-button" type="button" onClick={onClose}>
            Voltar ao cadastro
          </button>
        </footer>
      </section>
